...
const Navbar = () => {
  ...
  const currentAnswer = currentQuestion
    ? exam.savedAnswers[currentQuestion.id]
    : undefined;
  ...
  const handleSaveAndLogout = async () => {
    ...
    try {
      await userApi.saveAttemptAnswer(exam.attemptId, {
        questionId: currentQuestion.id,
        selectedOption: currentAnswer?.selectedOption ?? 0,
        lastQuestionIndex: exam.currentQuestionIndex,
      });
      handleLogout();
    } catch (error) {
      console.error("Save before logout failed", error);
  ...
  return (
    ...
    >
      <Container maxWidth={false} sx={{ px: { xs: 1.5, sm: 2, md: 4, lg: 6 } }}>
        <Toolbar
          disableGutters
          sx={{ minHeight: "inherit", gap: { xs: 0.8, sm: 1.2, md: 1 } }}
        >
          {/* Logo Section */}
          <Box
            sx={{
          ...
          >
            ...
            <Box sx={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                Exam
                <Box component="span" sx={{ color: "#2563EB", ml: 0.5 }}>
                  Platform
                </Box>
              </Typography>
              <Typography
                sx={{
                  fontSize: { xs: "0.55rem", md: "0.66rem" },
            ...
            >
              <LightMode
                sx={{
                  ...
                  color: themeMode === "dark" ? "#64748B" : "#F59E0B",
                }}
              />
              <Switch
              ...
              <DarkMode
                sx={{
                  fontSize: { xs: 14, sm: 16 },
                  color: themeMode === "dark" ? "#F8FAFC" : "#64748B",
                }}
              />
            </Box>
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      boxShadow: isTestScreen
                        ...
                        : "0 10px 20px rgba(239, 68, 68, 0.28)",
                    },
                  }}
                >
                ...
                <IconButton
                  ...
                  sx={{
                    ...
                    bgcolor: isTestScreen
                      ? alpha("#10B981", 0.1)
                      : alpha("#EF4444", 0.1),
                    border: `1px solid ${isTestScreen ? alpha("#10B981", 0.22) : alpha("#EF4444", 0.22)}`,
                  }}
                >
                  {isTestScreen ? (
