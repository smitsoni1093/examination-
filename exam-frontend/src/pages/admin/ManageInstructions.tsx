...
const ManageInstructions = () => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setMessage({
        type: "error",
        text:
          errorObj?.response?.data?.message || "Failed to create instruction.",
      });
    }
  };
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      await adminApi.updateInstruction(editId, {
        text: value,
        isActive: editActive,
      });
      setEditOpen(false);
      ...
      setMessage({
        type: "error",
        text:
          errorObj?.response?.data?.message || "Failed to update instruction.",
      });
    }
  };
  ...
  const handleDelete = async (id: number) => {
    try {
      ...
      setMessage({
        type: "error",
        text:
          errorObj?.response?.data?.message || "Failed to delete instruction.",
      });
    }
  };
