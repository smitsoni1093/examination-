...
const ViewResults = () => {
  ...
  const handleBulkRelease = async () => {
    try {
      ...
      console.error("Failed to bulk release results", error);
        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Assessment
                sx={{ color: "#10B981", mr: 1, fontSize: { xs: 20, sm: 24 } }}
              />
              <Typography
                variant="overline"
                sx={{
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  fontWeight: 700,
                  fontSize: { xs: "0.7rem", sm: "0.85rem" },
                  borderColor: isDark ? "rgba(148, 163, 184, 0.45)" : "#E2E8F0",
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <Search
                      sx={{ color: "#94A3B8", fontSize: { xs: 18, sm: 20 } }}
                    />
                  </InputAdornment>
                ),
              }}
      ...
      <Container maxWidth={false} sx={{ px: { xs: 2, sm: 3, md: 6, lg: 10 } }}>
            ...
            <TableHead sx={{ bgcolor: isDark ? "#000000" : "#F8FAFC" }}>
              <TableRow>
                ...
                >
                  <Checkbox
                    checked={
                      selectedResults.size === pagedResults.length &&
              ...
              {pagedResults.map((row) => {
                ...
                return (
                  <TableRow
                    ...
                    sx={{
                      "&:hover": { bgcolor: isDark ? "#111111" : "#F1F5F9" },
                  ...
                  >
                    ...
                    >
                      <Checkbox
                        ...
                        onChange={() =>
                          toggleResultSelection(row.userId, row.testId)
                        }
                        size="small"
                      />
                    </TableCell>
                    ...
                    >
                      <Box
                        sx={{ width: "100%", minWidth: { xs: 60, sm: 100 } }}
                      >
                        <Typography
                          variant="body2"
                          sx={{
                            ...
                            color: percentage >= 50 ? "#10B981" : "#EF4444",
                          }}
                        >
                          {percentage}%
                        </Typography>
                        <LinearProgress
                          ...
                          sx={{
                            ...
                            "& .MuiLinearProgress-bar": {
                              bgcolor: percentage >= 50 ? "#10B981" : "#EF4444",
                              borderRadius: 3,
                            },
                          }}
                        />
                    ...
                    >
                      ...
                      >
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/results/${row.userId}/${row.testId}/answers`,
                            )
                          }
                          sx={{
                            borderRadius: 1,
        ...
        {filteredResults.length > 0 && (
          ...
          >
            ...
            >
              Showing{" "}
              {Math.min((page - 1) * pageSize + 1, filteredResults.length)} -{" "}
