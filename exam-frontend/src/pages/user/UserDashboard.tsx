...
const UserDashboard = () => {
  ...
  const [tests, setTests] = useState<UserDashboardTest[]>([]);
        ...
        >
          <Box
            sx={{
              p: { xs: 3, md: 4 },
              background:
                "linear-gradient(140deg, #0B3C49 0%, #0F172A 50%, #1D4ED8 100%)",
              color: "#F8FAFC",
              position: "relative",
            }}
          >
            ...
            <Box sx={{ py: 11, textAlign: "center" }}>
              ...
              >
                ...
                <Typography color="text.secondary">
                  {t("userDashboard.loadingSecureSessions")}
                </Typography>
              </Stack>
            </Box>
          ) : (
              ...
              {tests.length === 0 ? (
                ...
                <Grid container spacing={{ xs: 1.8, md: 2.2 }}>
                  {tests.map((test, index) => {
                    const shouldContinueTest =
                      !!test.hasInProgressAttempt ||
                      (test.answeredCount ?? 0) > 0;
                    const canResumeReleased =
                      test.isReleased && !test.isResultPublished;
                    return (
                      <Grid
                        item
                        xs={12}
                            ...
                            <Stack spacing={0.95} sx={{ mb: 2.6 }}>
                              ...
                              >
                                ...
                                <Typography
                                  ...
                                  sx={{ fontWeight: 700 }}
                                >
                                  {t("userDashboard.questionsAssigned", {
                              ...
                              test.isSubmitted ? (
                                ...
                                >
                                  ...
                                  <Typography
                                    ...
                                    sx={{ fontWeight: 700 }}
                                  >
                                    {t("userDashboard.mcqProgress", {
                                      answered: test.answeredCount || 0,
                              ...
                              {test.closingAt && (
                                ...
                                >
                                  ...
                                  <Typography
                                    ...
                                    sx={{ fontWeight: 700 }}
                                  >
                                    {t("userDashboard.lastDateOfSubmission")}:{" "}
                                    {formatSubmissionDate(test.closingAt)}
                                  </Typography>
                                </Stack>
                              )}
                            </Stack>
                            ...
                            >
                              {test.isResultPublished ? (
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    navigate(`/user/instructions/${test.id}`)
                                  }
                                  sx={{
                                    py: 1.15,
                                    borderRadius: 2.2,
                                ...
                                >
                                  {shouldContinueTest
                                    ? t("userDashboard.continueTest")
                                    : t("userDashboard.enrollNow")}
                                </Button>
                              )}
                            </Box>
                          </CardContent>
